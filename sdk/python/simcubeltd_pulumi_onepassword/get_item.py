...
class GetItemResult:
    ...
    """
    def __init__(__self__, category=None, database=None, hostname=None, id=None, password=None, port=None, sections=None, tags=None, title=None, type=None, url=None, username=None, uuid=None, vault=None):
